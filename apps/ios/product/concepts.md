...
| 27 | Remote Desktop | [views/settings.md](views/settings.md) | [spec/architecture.md](../spec/architecture.md) | `RemoteAccess/ConnectDesktopView.swift`, `ChatList/ChatListView.swift`, `Model/SuspendChat.swift` | `Controller.hs`, `Remote.hs`, `Remote/Types.hs` |
