...
| Session management | Manage active desktop control sessions in background while continuing to use the mobile app | `Shared/Views/RemoteAccess/ConnectDesktopView.swift` |
